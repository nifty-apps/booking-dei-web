...
export type BookingsQuery = { __typename?: 'Query', bookings: Array<{ __typename?: 'Booking', _id: string, customer: string, number?: number | null, hotel: string, paymentStatus: PaymentStatus }> };
